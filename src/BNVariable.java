...
public class BNVariable {
    ...
    private ArrayList<Double> probTable; // Probability table associated with this variable (linked to parents).
     ...
     */
    public void setProbTable(ArrayList<Double> probTable) {
        this.probTable = probTable;
    }
}
